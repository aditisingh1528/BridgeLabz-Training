    ...
    sealed class AddressBookMenu
    {
        ...
        private void AddressBookOperationsMenu()
        {
            while (true)
            {
                ...
                switch (choice)
                {
                    case 1: addressService.AddContact(); break;
                    case 2: addressService.EditContact(); break;
                    case 3: addressService.DeleteContact(); break;
                    case 4: addressService.AddMultipleContacts(); break;
                    case 5: addressService.SearchPersonByCityOrState(); break;
                    case 6: addressService.ViewPersonsByCityOrState(); break;
                    case 7: addressService.CountByCityOrState(); break;
                    case 8: addressService.SortContactsByName(); break;
                    case 9: addressService.SortContactsByCityStateOrZip(); break;
                    case 10: addressService.DisplayContact(); break;
                    case 11: return;
                }
            }
        }
